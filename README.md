...
- **演習モード（過去問）**: **学校（出典）→ 方式・年度**の2階層で切り替え。帝京大学（総合型／学校推薦型）・日本大学（N全学統一方式第1期 2026）を収録。段階ヒント・小問ごとの採点・進捗保存に対応。
- **試験モード（ミニ試験）**: 学校切替で「数学ミニ試験」を選ぶと、30分・100点の模擬試験に切り替わる。試験中は正誤・解説を出さず、提出後に採点と解説を表示。タイマー・クリック式テンキー・A4印刷対応。全6回構成を予定し、現在は第1回・第2回を公開。
