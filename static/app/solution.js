...
import { $, escapeHtml, mdLite, solutionTextHtml, renderMath } from "./dom.js?v=20260907-keep-check-result";
import { DETAIL_TEXTS, DETAIL_STEP_LABELS, MATH_SOLUTIONS } from "./datasets.js?v=20260907-keep-check-result";
