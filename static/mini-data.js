      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            solution: "${}_{5}C_{2}{}_{4}C_{1}=10\\cdot4=40$ 通り。"
          },
          {
            ...
            solution: "$(0,0)$ から $(1,1)$ は ${}_{2}C_{1}=2$ 通り、そこから $(3,2)$ は ${}_{3}C_{1}=3$ 通り。積の法則で $2\\cdot3=6$ 通り。"
          }
        ]
      }
    ]
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            solution: "女子の選び方 ${}_{4}C_{2}=6$ 通り、男子の選び方 ${}_{6}C_{2}=15$ 通り。積の法則で $6\\cdot15=90$ 通り。"
          },
          {
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            solution: "7人から3人を選ぶ全体は ${}_{7}C_{3}=35$ 通り。男子だけを選ぶ方法は ${}_{3}C_{3}=1$ 通り、女子だけを選ぶ方法は ${}_{4}C_{3}=4$ 通り。したがって、$35-1-4=30$ 通り。"
          },
          {
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            solution: "女子が2人のときは ${}_{4}C_{2}{}_{5}C_{2}=6\\cdot10=60$ 通り、3人のときは ${}_{4}C_{3}{}_{5}C_{1}=4\\cdot5=20$ 通り、4人のときは ${}_{4}C_{4}=1$ 通り。合計 $60+20+1=81$ 通り。"
          }
        ]
      },
      {
        ...
        questions: [
          {
            ...
            solution: "全体の取り出し方は ${}_{5}C_{2}=10$ 通り。色が異なる取り出し方は $3\\cdot2=6$ 通りなので、確率は $\\dfrac6{10}=\\dfrac35$。"
          },
          {
          ...
          },
          {
            ...
            solution: "表がちょうど2回出る並び方は ${}_{4}C_{2}=6$ 通り、全体は $2^4=16$ 通り。したがって確率は $\\dfrac6{16}=\\dfrac38$。"
          }
        ]
      }
    ]
    ...
    groups: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            solution: "<strong>考え方：</strong>「同じ色」は「2個とも赤」または「2個とも白」なので、それぞれの場合の数を求めて足します。<br><strong>手順：</strong>全体の取り出し方は9個から2個を選ぶ組合せで ${}_{9}C_{2}=36$ 通り。2個とも赤は ${}_{4}C_{2}=6$ 通り、2個とも白は ${}_{5}C_{2}=10$ 通り。同じ色になる場合は $6+10=16$ 通りなので、確率は $\\dfrac{16}{36}=\\dfrac49$。<br><strong>注意：</strong>「同時に2個取り出す」ので組合せを使います。赤と白の場合を別々に数えてから足すのを忘れないようにします。<br><strong>答え：</strong>$\\dfrac49$。"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            solution: "<strong>考え方：</strong>(2)で求めた8枚の中から2枚とも選ぶ場合の数を、全体の2枚の選び方で割ります。<br><strong>手順：</strong>全体の選び方は ${}_{15}C_{2}=105$ 通り。「$A$ にも $B$ にも属さない」8枚から2枚を選ぶ方法は ${}_{8}C_{2}=28$ 通り。確率は $\\dfrac{28}{105}$ で、分子分母を7で割ると $\\dfrac4{15}$ です。<br><strong>注意：</strong>「同時に2枚」なので組合せを使います。(2)で出した8という枚数を、そのまま ${}_{8}C_{2}$ の計算に使えることを確認します。<br><strong>答え：</strong>$\\dfrac4{15}$。"
          },
          {
    ...
    groups: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            solution: "<strong>考え方：</strong>部分集合は、各要素について「入れる／入れない」を決める作業なので $2^n$ 個です。要素数を指定したものは組合せで数えます。<br><strong>手順：</strong>要素は5個なので部分集合は $2^5=32$ 個。要素がちょうど2個のものは5個から2個を選ぶ組合せで ${}_{5}C_{2}=\\dfrac{5\\times4}{2\\times1}=10$ 個です。<br><strong>注意：</strong>部分集合には空集合と $A$ 自身も含まれます（$32$ にはこの2つが入っています）。数え忘れに注意します。<br><strong>答え：</strong>部分集合は32個、要素2個のものは10個。"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            solution: "<strong>考え方：</strong>選ぶ順番は関係ないので、組合せ ${}_{n}C_{3}$ を使います。$n$ は(2)で求めた $n(A\\cup B)$ です。<br><strong>手順：</strong>(2)より $n(A\\cup B)=24$ なので、${}_{24}C_{3}=\\dfrac{24\\times23\\times22}{3\\times2\\times1}=\\dfrac{12144}{6}=2024$ 通り。<br><strong>注意：</strong>「選ぶ」だけで並べないので順列 $_{24}\\mathrm{P}_3$ ではありません。$3!=6$ で割るのを忘れないようにします。<br><strong>答え：</strong>2024通り。"
          },
          {
            ...
            solution: "<strong>考え方：</strong>「少なくとも1枚」は場合分けが増えるので、余事象「2枚とも $A\\cap B$ に属さない」を全体から引きます。<br><strong>手順：</strong>全体の選び方は ${}_{50}C_{2}=\\dfrac{50\\times49}{2}=1225$ 通り。(1)より $n(A\\cap B)=4$ なので、$A\\cap B$ に属さないカードは $50-4=46$ 枚あり、そこから2枚選ぶ方法は ${}_{46}C_{2}=\\dfrac{46\\times45}{2}=1035$ 通り。よって $1225-1035=190$ 通りです。<br><strong>注意：</strong>直接数えると「ちょうど1枚」$4\\times46=184$ 通りと「2枚とも」${}_{4}C_{2}=6$ 通りの和で $190$ 通りとなり、一致します（検算に使えます）。<br><strong>答え：</strong>190通り。"
          }
        ]
      }
    ]
